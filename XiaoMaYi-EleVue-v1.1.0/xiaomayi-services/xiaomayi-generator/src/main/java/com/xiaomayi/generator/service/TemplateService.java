...
package com.xiaomayi.generator.service;
...
public interface TemplateService extends IService<Template> {
     ...
     * @return 返回结果
     */
    Page<Template> page(TemplatePageDTO templatePageDTO);
     ...
     * @return 返回结果
     */
    TemplateInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(TemplateAddDTO templateAddDTO);
     ...
     * @return 返回结果
     */
    R update(TemplateUpdateDTO templateUpdateDTO);
