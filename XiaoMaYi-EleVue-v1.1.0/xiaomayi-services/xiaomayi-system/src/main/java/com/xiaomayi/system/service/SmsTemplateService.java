...
public interface SmsTemplateService extends IService<SmsTemplate> {
     ...
     * @return 返回结果
     */
    Page<SmsTemplate> page(SmsTemplatePageDTO smsTemplatePageDTO);
     ...
     * @return 返回结果
     */
    SmsTemplate getInfo(Integer id);
     ...
     * @return 返回结果
     */
    SmsTemplateInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(SmsTemplateAddDTO smsTemplateAddDTO);
     ...
     * @return 返回结果
     */
    R update(SmsTemplateUpdateDTO smsTemplateUpdateDTO);
     ...
     * @return 返回结果
     */
    boolean checkExist(String number, Integer id);
     ...
     * @return 返回结果
     */
    SmsTemplate getSmsTemplate(String number);
     ...
     * @return 返回结果
     */
    R sendSms(SmsSendDTO smsSendDTO);
