...
public interface PositionService extends IService<Position> {
     ...
     * @return 返回结果
     */
    Page<Position> page(PositionPageDTO positionPageDTO);
     ...
     * @return 返回结果
     */
    List<PositionListVO> getList(PositionListDTO positionListDTO);
     ...
     * @return 返回结果
     */
    PositionInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(PositionAddDTO positionAddDTO);
