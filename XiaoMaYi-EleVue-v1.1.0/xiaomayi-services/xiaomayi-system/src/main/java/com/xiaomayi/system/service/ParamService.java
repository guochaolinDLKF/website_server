...
public interface ParamService extends IService<Param> {
     ...
     * @return 返回结果
     */
    Page<Param> page(ParamPageDTO paramPageDTO);
     ...
     * @return 返回结果
     */
    ParamInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R update(ParamUpdateDTO paramUpdateDTO);
     ...
     * @return 返回结果
     */
    Param getParamInfo(String paramCode);
