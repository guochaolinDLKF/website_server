...
public interface SmsLogService extends IService<SmsLog> {
     ...
     * @return 返回结果
     */
    Page<SmsLog> page(SmsLogPageDTO smsLogPageDTO);
     ...
     * @return 返回结果
     */
    SmsLogInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(SmsLogAddDTO smsLogAddDTO);
