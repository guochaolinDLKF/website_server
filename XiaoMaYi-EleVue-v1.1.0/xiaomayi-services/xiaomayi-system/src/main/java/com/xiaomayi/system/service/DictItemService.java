...
public interface DictItemService extends IService<DictItem> {
     ...
     * @return 返回结果
     */
    Page<DictItem> page(DictItemPageDTO dictItemPageDTO);
     ...
     * @return 返回结果
     */
    List<DictItemListVO> getList(DictItemListDTO dictItemListDTO);
     ...
     * @return 返回结果
     */
    DictItemInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(DictItemAddDTO dictItemAddDTO);
     ...
     * @return 返回结果
     */
    R update(DictItemUpdateDTO dictItemUpdateDTO);
