...
public interface FileTemplateService extends IService<FileTemplate> {
     ...
     * @return 返回结果
     */
    Page<FileTemplate> page(FileTemplatePageDTO fileTemplatePageDTO);
     ...
     * @return 返回结果
     */
    FileTemplate getInfo(Integer id);
     ...
     * @return 返回结果
     */
    FileTemplateInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(FileTemplateAddDTO fileTemplateAddDTO);
     ...
     * @return 返回结果
     */
    R update(FileTemplateUpdateDTO fileTemplateUpdateDTO);
     ...
     * @return 返回结果
     */
    FileTemplate getTemplateByCode(String code);
}
