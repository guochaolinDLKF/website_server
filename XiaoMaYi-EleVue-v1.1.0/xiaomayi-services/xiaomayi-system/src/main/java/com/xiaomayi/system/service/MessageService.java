...
public interface MessageService extends IService<Message> {
     ...
     * @return 返回结果
     */
    Page<Message> page(MessagePageDTO messagePageDTO);
     ...
     * @return 返回结果
     */
    MessageInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(MessageAddDTO messageAddDTO);
     ...
     * @return 返回结果
     */
    R update(MessageUpdateDTO messageUpdateDTO);
     ...
     * @return 返回结果
     */
    R sendMessage(MessageSendDTO messageSendDTO);
     ...
     * @return 返回结果
     */
    R profile(MessagePageDTO messagePageDTO);
     ...
     * @return 返回结果
     */
    R setRead(MessageReadDTO messageReadDTO);
