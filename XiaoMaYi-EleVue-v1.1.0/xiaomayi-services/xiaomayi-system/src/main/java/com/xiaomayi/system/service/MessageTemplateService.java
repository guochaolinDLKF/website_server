...
public interface MessageTemplateService extends IService<MessageTemplate> {
     ...
     * @return 返回结果
     */
    Page<MessageTemplate> page(MessageTemplatePageDTO messageTemplatePageDTO);
     ...
     * @return 返回结果
     */
    MessageTemplate getInfo(Integer id);
     ...
     * @return 返回结果
     */
    MessageTemplateInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(MessageTemplateAddDTO messageTemplateAddDTO);
     ...
     * @return 返回结果
     */
    R update(MessageTemplateUpdateDTO messageTemplateUpdateDTO);
     ...
     * @return 返回结果
     */
    MessageTemplate getTemplateInfo(String number);
