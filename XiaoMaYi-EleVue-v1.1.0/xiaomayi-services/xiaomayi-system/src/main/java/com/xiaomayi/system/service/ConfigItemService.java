...
public interface ConfigItemService extends IService<ConfigItem> {
     ...
     * @return 返回结果
     */
    Page<ConfigItem> page(ConfigItemPageDTO configItemPageDTO);
     ...
     * @return 返回结果
     */
    List<ConfigItemListVO> getList(ConfigItemListDTO configItemListDTO);
     ...
     * @return 返回结果
     */
    ConfigItemInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(ConfigItemAddDTO configItemAddDTO);
     ...
     * @return 返回结果
     */
    R update(ConfigItemUpdateDTO configItemUpdateDTO);
     ...
     * @return 返回结果
     */
    ConfigItem getConfigItem(String code);
     ...
     * @return 返回结果
     */
    Map<String, String> getItemList(String code);
