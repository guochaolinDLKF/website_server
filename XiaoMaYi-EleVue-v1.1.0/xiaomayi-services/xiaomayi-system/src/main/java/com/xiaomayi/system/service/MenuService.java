...
public interface MenuService extends IService<Menu> {
     ...
     * @return 返回结果
     */
    List<MenuListVO> getList(MenuListDTO menuListDTO);
     ...
     * @return 返回结果
     */
    MenuInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R update(MenuUpdateDTO menuUpdateDTO);
     ...
     * @return 返回结果
     */
    List<MenuListVO> getMenus(Integer userId);
     ...
     * @return 返回结果
     */
    List<Menu> getMenuList(Integer tenantId);
     ...
     * @return 返回结果
     */
    R deleteByParentId(Integer parentId);
     ...
     * @return 返回结果
     */
    R batchAddMenu(List<Menu> menuList);
