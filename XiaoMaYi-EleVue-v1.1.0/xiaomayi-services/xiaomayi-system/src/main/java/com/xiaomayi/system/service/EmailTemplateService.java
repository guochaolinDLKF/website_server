...
public interface EmailTemplateService extends IService<EmailTemplate> {
     ...
     * @return 返回结果
     */
    Page<EmailTemplate> page(EmailTemplatePageDTO emailTemplatePageDTO);
     ...
     * @return 返回结果
     */
    EmailTemplate getInfo(Integer id);
     ...
     * @return 返回结果
     */
    EmailTemplateInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(EmailTemplateAddDTO emailTemplateAddDTO);
     ...
     * @return 返回结果
     */
    R update(EmailTemplateUpdateDTO emailTemplateUpdateDTO);
     ...
     * @return 返回结果
     */
    R sendEmail(EmailSendDTO emailSendDTO);
