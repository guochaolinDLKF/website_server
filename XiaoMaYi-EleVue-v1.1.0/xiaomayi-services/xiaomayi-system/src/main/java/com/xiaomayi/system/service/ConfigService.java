...
public interface ConfigService extends IService<Config> {
     ...
     * @return 返回结果
     */
    Page<Config> page(ConfigPageDTO configPageDTO);
     ...
     * @return 返回结果
     */
    List<ConfigListVO> getList(ConfigListDTO configListDTO);
     ...
     * @return 返回结果
     */
    ConfigInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(ConfigAddDTO configAddDTO);
     ...
     * @return 返回结果
     */
    R update(ConfigUpdateDTO configUpdateDTO);
