...
public interface LevelService extends IService<Level> {
     ...
     * @return 返回结果
     */
    Page<Level> page(LevelPageDTO levelPageDTO);
     ...
     * @return 返回结果
     */
    List<LevelListVO> getList(LevelListDTO levelListDTO);
     ...
     * @return 返回结果
     */
    LevelInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R update(LevelUpdateDTO levelUpdateDTO);
     ...
     * @return 返回结果
     */
    R importLevel(List<LevelExcelVO> levelExcelVOList);
     ...
     * @return 返回结果
     */
    R exportLevel(LevelListDTO levelListDTO);
}
