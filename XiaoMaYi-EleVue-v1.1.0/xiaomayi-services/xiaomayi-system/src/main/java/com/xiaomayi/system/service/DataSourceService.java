...
public interface DataSourceService extends IService<DataSource> {
     ...
     * @return 返回结果
     */
    Page<DataSource> page(DataSourcePageDTO dataSourcePageDTO);
     ...
     * @return 返回结果
     */
    DataSourceInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(DataSourceAddDTO dataSourceAddDTO);
     ...
     * @return 返回结果
     */
    R update(DataSourceUpdateDTO dataSourceUpdateDTO);
