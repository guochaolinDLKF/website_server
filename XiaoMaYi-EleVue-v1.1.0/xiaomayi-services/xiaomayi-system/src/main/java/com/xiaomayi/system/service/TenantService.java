...
public interface TenantService extends IService<Tenant> {
     ...
     * @return 返回结果
     */
    Page<Tenant> page(TenantPageDTO tenantPageDTO);
     ...
     * @return 返回结果
     */
    TenantInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(TenantAddDTO tenantAddDTO);
     ...
     * @return 返回结果
     */
    R update(TenantUpdateDTO tenantUpdateDTO);
     ...
     * @return 返回结果
     */
    R addAccount(TenantAccountDTO tenantAccountDTO);
