...
package com.xiaomayi.system.dto.example2;
 ...
 */
@Data
@Schema(name = "案例演示2添加DTO", description = "案例演示2添加DTO")
public class Example2AddDTO {
