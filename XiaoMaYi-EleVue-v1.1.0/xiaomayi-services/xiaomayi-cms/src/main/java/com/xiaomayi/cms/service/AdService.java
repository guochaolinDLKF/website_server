...
public interface AdService extends IService<Ad> {
     ...
     * @return 返回结果
     */
    Page<Ad> page(AdPageDTO adPageDTO);
     ...
     * @return 返回结果
     */
    List<Ad> getList(AdListDTO adListDTO);
     ...
     * @return 返回结果
     */
    R update(AdUpdateDTO adUpdateDTO);
