...
public interface LayoutService extends IService<Layout> {
     ...
     * @return 返回结果
     */
    Page<Layout> page(LayoutPageDTO layoutPageDTO);
     ...
     * @return 返回结果
     */
    List<Layout> getList(LayoutListDTO layoutListDTO);
     ...
     * @return 返回结果
     */
    LayoutInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(LayoutAddDTO layoutAddDTO);
     ...
     * @return 返回结果
     */
    R update(LayoutUpdateDTO layoutUpdateDTO);
