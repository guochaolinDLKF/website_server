...
import com.xiaomayi.cms.mapper.CategoryMapper;
import com.xiaomayi.cms.service.CategoryService;
import com.xiaomayi.cms.vo.category.CategoryInfoVO;
...
public class CategoryServiceImpl extends ServiceImpl<CategoryMapper, Category> implements CategoryService {
     ...
     */
    @Override
    public List<Category> getList(CategoryListDTO categoryListDTO) {
     ...
     */
    @Override
    public CategoryInfoVO getDetail(Integer id) {
        Category category = getInfo(id);
     ...
     */
    @Override
    public R update(CategoryUpdateDTO categoryUpdateDTO) {
        // 根据ID查询信息
        Category category = getInfo(categoryUpdateDTO.getId());
        if (StringUtils.isNull(category)) {
