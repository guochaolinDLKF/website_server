 ...
 * @since 2024-07-03
 */
public interface LayoutItemService extends IService<LayoutItem> {
     ...
     * @return 返回结果
     */
    Page<LayoutItem> page(LayoutItemPageDTO layoutItemPageDTO);
     ...
     * @return 返回结果
     */
    LayoutItemInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(LayoutItemAddDTO layoutItemAddDTO);
     ...
     * @return 返回结果
     */
    R update(LayoutItemUpdateDTO layoutItemUpdateDTO);
