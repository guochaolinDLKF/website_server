...
public interface LinkService extends IService<Link> {
     ...
     * @return 返回结果
     */
    Page<Link> page(LinkPageDTO linkPageDTO);
     ...
     * @return 返回结果
     */
    LinkInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R update(LinkUpdateDTO linkUpdateDTO);
