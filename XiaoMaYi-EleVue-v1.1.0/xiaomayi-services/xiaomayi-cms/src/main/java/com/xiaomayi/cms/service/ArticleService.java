...
public interface ArticleService extends IService<Article> {
     ...
     * @return 返回结果
     */
    Page<Article> page(ArticlePageDTO articlePageDTO);
     ...
     * @return 返回结果
     */
    ArticleInfoVO getDetail(Integer id);
     ...
     * @return 返回结果
     */
    R add(ArticleAddDTO articleAddDTO);
     ...
     * @return 返回结果
     */
    R update(ArticleUpdateDTO articleUpdateDTO);
