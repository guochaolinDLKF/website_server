...
import com.xiaomayi.generator.dto.generator.GeneratorTableDTO;
...
public class GeneratorController {
    ...
    @GetMapping("/page")
    public R page(GeneratorPageDTO tablePageDTO) {
        return R.ok(generatorService.page(tablePageDTO));
    }
