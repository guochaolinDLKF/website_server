...
public class DeptController {
    ...
    @PreAuthorize("@pms.hasAuthority('sys:dept:list')")
    @GetMapping("/list")
    public R getList(DeptListDTO deptListDTO) {
        return R.ok(deptService.getList(deptListDTO));
    }
    ...
    @PreAuthorize("@pms.hasAuthority('sys:dept:detail')")
    ...
    @RequestLog(title = "添加部门", type = RequestType.INSERT)
    @PreAuthorize("@pms.hasAuthority('sys:dept:add')")
    @PostMapping("/add")
    public R add(@RequestBody @Validated DeptAddDTO deptAddDTO) {
        return deptService.add(deptAddDTO);
    }
    ...
    @RequestLog(title = "更新部门", type = RequestType.UPDATE)
    @PreAuthorize("@pms.hasAuthority('sys:dept:update')")
    @PutMapping("/update")
    public R update(@RequestBody @Validated DeptUpdateDTO deptUpdateDTO) {
    ...
    @RequestLog(title = "删除部门", type = RequestType.DELETE)
    @PreAuthorize("@pms.hasAuthority('sys:dept:delete')")
