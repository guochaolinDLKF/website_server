...
@Tag(name = "文件日志管理", description = "文件日志管理")
@AllArgsConstructor
public class FileLogController {
    ...
    @GetMapping("/page")
    public R page(FileLogPageDTO fileLogPageDTO) {
        return R.ok(fileLogService.page(fileLogPageDTO));
    }
    ...
    public R getDetail(@PathVariable("id") Integer id) {
        return R.ok(fileLogService.getDetail(id));
    }
    ...
    @RequestLog(title = "删除文件", type = RequestType.DELETE)
    @PreAuthorize("@pms.hasAuthority('sys:fileLog:delete')")
    @DeleteMapping("/delete/{id}")
    public R delete(@PathVariable Integer id) {
        return fileLogService.delete(id);
    }
    ...
    @RequestLog(title = "批量删除文件", type = RequestType.BATCH_DELETE)
    @PreAuthorize("@pms.hasAuthority('sys:fileLog:batchDelete')")
    @DeleteMapping("/batchDelete")
    public R batchDelete(@RequestBody @Validated List<Integer> idList) {
        return fileLogService.batchDelete(idList);
    }
