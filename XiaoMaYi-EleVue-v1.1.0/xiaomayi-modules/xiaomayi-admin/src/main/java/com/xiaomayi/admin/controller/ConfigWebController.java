...
public class ConfigWebController {
    ...
    @PreAuthorize("@pms.hasAuthority('sys:configweb:index')")
    @GetMapping("/index")
    public R index() {
        return configWebService.index();
    }
    ...
    @PreAuthorize("@pms.hasAuthority('sys:configWeb:save')")
    @PostMapping("/save")
    public R save(@RequestBody Map<String, Object> data) {
        return configWebService.save(data);
    }
