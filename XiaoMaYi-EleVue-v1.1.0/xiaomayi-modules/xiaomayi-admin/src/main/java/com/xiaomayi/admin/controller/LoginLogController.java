...
public class LoginLogController {
    ...
    @PreAuthorize("@pms.hasAuthority('sys:loginLog:page')")
    @GetMapping("/page")
    public R page(LoginLogPageDTO loginLogPageDTO) {
        return R.ok(loginLogService.page(loginLogPageDTO));
    }
    ...
    @PreAuthorize("@pms.hasAuthority('sys:loginLog:detail')")
    @GetMapping("/detail/{id}")
    public R getDetail(@PathVariable("id") Integer id) {
        return R.ok(loginLogService.getDetail(id));
    }
    ...
    @RequestLog(title = "删除登录日志", type = RequestType.DELETE)
    @PreAuthorize("@pms.hasAuthority('sys:loginLog:delete')")
    @DeleteMapping("/delete/{id}")
    public R delete(@PathVariable Integer id) {
        List<Integer> idList = Collections.singletonList(id);
        return loginLogService.delete(idList);
    }
    ...
    @RequestLog(title = "批量删除登录日志", type = RequestType.BATCH_DELETE)
    @PreAuthorize("@pms.hasAuthority('sys:loginLog:batchDelete')")
