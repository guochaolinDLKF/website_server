...
public class ArticleController {
    ...
    @GetMapping("/page")
    public R page(ArticlePageDTO articlePageDTO) {
        return R.ok(articleService.page(articlePageDTO));
    }
    ...
    @RequestLog(title = "添加文章", type = RequestType.INSERT)
    @PreAuthorize("@pms.hasAuthority('sys:article:add')")
    @PostMapping("/add")
    public R add(@RequestBody @Validated ArticleAddDTO articleAddDTO) {
    ...
    @RequestLog(title = "更新文章", type = RequestType.UPDATE)
    @PreAuthorize("@pms.hasAuthority('sys:article:update')")
    @PutMapping("/update")
    public R update(@RequestBody @Validated ArticleUpdateDTO articleUpdateDTO) {
    ...
    @RequestLog(title = "删除文章", type = RequestType.DELETE)
    @PreAuthorize("@pms.hasAuthority('sys:article:delete')")
    ...
    @RequestLog(title = "批量删除文章", type = RequestType.BATCH_DELETE)
    @PreAuthorize("@pms.hasAuthority('sys:article:batchDelete')")
