...
public class OperLogController {
    ...
    @PreAuthorize("@pms.hasAuthority('sys:operLog:page')")
    @GetMapping("/page")
    public R page(OperLogPageDTO operLogPageDTO) {
        return R.ok(operLogService.page(operLogPageDTO));
    }
    ...
    @PreAuthorize("@pms.hasAuthority('sys:operLog:detail')")
    @GetMapping("/detail/{id}")
    public R getDetail(@PathVariable("id") Integer id) {
        return R.ok(operLogService.getDetail(id));
    }
    ...
    @RequestLog(title = "删除操作日志", type = RequestType.DELETE)
    @PreAuthorize("@pms.hasAuthority('sys:operLog:delete')")
    @DeleteMapping("/delete/{id}")
    public R delete(@PathVariable Integer id) {
        List<Integer> idList = Collections.singletonList(id);
        return operLogService.delete(idList);
    }
    ...
    @RequestLog(title = "批量删除操作日志", type = RequestType.BATCH_DELETE)
    @PreAuthorize("@pms.hasAuthority('sys:operLog:batchDelete')")
