...
public class ConfigController {
    ...
    @GetMapping("/page")
    public R page(ConfigPageDTO configPageDTO) {
        return R.ok(configService.page(configPageDTO));
    }
    ...
    @GetMapping("/list")
    public R getList(ConfigListDTO configListDTO) {
        return R.ok(configService.getList(configListDTO));
    }
    ...
    @RequestLog(title = "添加配置", type = RequestType.INSERT)
    @PreAuthorize("@pms.hasAuthority('sys:config:add')")
    @PostMapping("/add")
    public R add(@RequestBody @Validated ConfigAddDTO configAddDTO) {
        return configService.add(configAddDTO);
    }
    ...
    @RequestLog(title = "更新配置", type = RequestType.UPDATE)
    @PreAuthorize("@pms.hasAuthority('sys:config:update')")
    @PutMapping("/update")
    public R update(@RequestBody @Validated ConfigUpdateDTO configUpdateDTO) {
        return configService.update(configUpdateDTO);
    }
    ...
    @RequestLog(title = "批量删除配置", type = RequestType.BATCH_DELETE)
